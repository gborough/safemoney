...
module ISO4217_AFN: Custom = struct
  ...
  let units =
    ...
    let afghani = Discrete.Scale.make_scale symbol "afghani" (make_q "1/1") in
...
module ISO4217_ALL: Custom = struct
  ...
  let units =
    ...
    let qindarke = Discrete.Scale.make_scale symbol "qindarke" (make_q "100/1") in
...
module ISO4217_DZD: Custom = struct
  ...
  let units =
    ...
    let santeem = Discrete.Scale.make_scale symbol "santeem" (make_q "100/1") in
...
module ISO4217_AOA: Custom = struct
  ...
  let units =
    ...
    let centimo = Discrete.Scale.make_scale symbol "centimo" (make_q "100/1") in
...
module ISO4217_ARS: Custom = struct
  ...
  let units =
    ...
    let centavo = Discrete.Scale.make_scale symbol "centavo" (make_q "100/1") in
...
module ISO4217_BYN: Custom = struct
  ...
  let units =
    ...
    let kapiejka = Discrete.Scale.make_scale symbol "kapiejka" (make_q "100/1") in
...
module ISO4217_XOF: Custom = struct
  ...
  let units =
    ...
    let centime = Discrete.Scale.make_scale symbol "centime" (make_q "100/1") in
...
module ISO4217_BTN: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let ngultrum = Discrete.Scale.make_scale symbol "ngultrum" (make_q "100/1") in
    let chetrum = Discrete.Scale.make_scale symbol "chetrum" (make_q "100/1") in
...
module ISO4217_BOB: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let boliviano = Discrete.Scale.make_scale symbol "boliviano" (make_q "1/1") in
    let centavo = Discrete.Scale.make_scale symbol "centavo" (make_q "100/1") in
...
module ISO4217_BAM: Custom = struct
  ...
  let units =
    ...
    let fening = Discrete.Scale.make_scale symbol "fening" (make_q "100/1") in
...
module ISO4217_BGN: Custom = struct
  ...
  let units =
    ...
    let stotinka = Discrete.Scale.make_scale symbol "stotinka" (make_q "100/1") in
...
module ISO4217_ANG: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let guilder = Discrete.Scale.make_scale symbol "guilder" (make_q "1/1") in
    let cent = Discrete.Scale.make_scale symbol "cent" (make_q "100/1") in
...
module ISO4217_EGP: Custom = struct
  ...
  let units =
    ...
    let piastre = Discrete.Scale.make_scale symbol "piastre" (make_q "100/1") in
...
module ISO4217_SZL: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let lilangeni = Discrete.Scale.make_scale symbol "lilangeni" (make_q "1/1") in
    let cent = Discrete.Scale.make_scale symbol "cent" (make_q "100/1") in
...
module ISO4217_ETB: Custom = struct
  ...
  let units =
    ...
    let santim = Discrete.Scale.make_scale symbol "santim" (make_q "100/1") in
...
module ISO4217_GHS: Custom = struct
  ...
  let units =
    ...
    let pesewa = Discrete.Scale.make_scale symbol "pesewa" (make_q "100/1") in
...
module ISO4217_GTQ: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let quetzal = Discrete.Scale.make_scale symbol "quetzal" (make_q "1/1") in
    let centavo = Discrete.Scale.make_scale symbol "centavo" (make_q "100/1") in
...
module ISO4217_HNL: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let lempira = Discrete.Scale.make_scale symbol "lempira" (make_q "1/1") in
    let centavo = Discrete.Scale.make_scale symbol "centavo" (make_q "100/1") in
...
module ISO4217_HUF: Custom = struct
  ...
  let units =
    ...
    let filler = Discrete.Scale.make_scale symbol "filler" (make_q "100/1") in
...
module ISO4217_KES: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let shilling = Discrete.Scale.make_scale symbol "shilling" (make_q "1/1") in
    let cent = Discrete.Scale.make_scale symbol "cent" (make_q "100/1") in
...
module ISO4217_LYD: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let dinar = Discrete.Scale.make_scale symbol "dinar" (make_q "1/1") in
    let dirham = Discrete.Scale.make_scale symbol "dirham" (make_q "1000/1") in
    Hashtbl.set table ~key: "dinar" ~data: dinar;
...
module ISO4217_CHF: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let franc = Discrete.Scale.make_scale symbol "franc" (make_q "1/1") in
    let rappen = Discrete.Scale.make_scale symbol "rappen" (make_q "100/1") in
    Hashtbl.set table ~key: "franc" ~data: franc;
...
module ISO4217_MGA: Custom = struct
  ...
  let units =
    ...
    let iraimbilanja = Discrete.Scale.make_scale symbol "iraimbilanja" (make_q "5/1") in
...
module ISO4217_MWK: Custom = struct
  ...
  let units =
    ...
    let tambala = Discrete.Scale.make_scale symbol "tambala" (make_q "100/1") in
...
module ISO4217_MYR: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let ringgit = Discrete.Scale.make_scale symbol "ringgit" (make_q "1/1") in
    let sen = Discrete.Scale.make_scale symbol "sen" (make_q "100/1") in
...
module ISO4217_MVR: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let rufiyaa = Discrete.Scale.make_scale symbol "rufiyaa" (make_q "1/1") in
...
module ISO4217_NIO: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let cordoba = Discrete.Scale.make_scale symbol "cordoba" (make_q "1/1") in
    let centavo = Discrete.Scale.make_scale symbol "centavo" (make_q "100/1") in
...
module ISO4217_PAB: Custom = struct
  ...
  let units =
    ...
    let centesimo = Discrete.Scale.make_scale symbol "centesimo" (make_q "100/1") in
...
module ISO4217_PYG: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let guarani = Discrete.Scale.make_scale symbol "guarani" (make_q "1/1") in
    let centimo = Discrete.Scale.make_scale symbol "centimo" (make_q "100/1") in
...
module ISO4217_QAR: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let rial = Discrete.Scale.make_scale symbol "rial" (make_q "1/1") in
    let dirham = Discrete.Scale.make_scale symbol "dirham" (make_q "100/1") in
    Hashtbl.set table ~key: "rial" ~data: rial;
    Hashtbl.set table ~key: "dirham" ~data: dirham;
    Some table
...
module ISO4217_STN: Custom = struct
  ...
  let units =
    ...
    let centimos = Discrete.Scale.make_scale symbol "centimos" (make_q "100/1") in
...
module ISO4217_SAR: Custom = struct
  ...
  let units =
    ...
    let halala = Discrete.Scale.make_scale symbol "halala" (make_q "100/1") in
...
module ISO4217_THB: Custom = struct
  ...
  let units =
    ...
    let satang = Discrete.Scale.make_scale symbol "satang" (make_q "100/1") in
...
module ISO4217_TOP: Custom = struct
  ...
  let units =
    ...
    let seniti = Discrete.Scale.make_scale symbol "seniti" (make_q "100/1") in
...
module ISO4217_TND: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let dinar = Discrete.Scale.make_scale symbol "dinar" (make_q "1/1") in
    let millime = Discrete.Scale.make_scale symbol "millime" (make_q "100/1") in
    Hashtbl.set table ~key: "dinar" ~data: dinar;
...
module ISO4217_TMT: Custom = struct
  ...
  let units =
    ...
    let tennesi = Discrete.Scale.make_scale symbol "tennesi" (make_q "100/1") in
    Hashtbl.set table ~key: "manat" ~data: manat;
...
module ISO4217_UAH: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let hryvnia = Discrete.Scale.make_scale symbol "hryvnia" (make_q "1/1") in
    let kopiyka = Discrete.Scale.make_scale symbol "kopiyka" (make_q "100/1") in
...
module ISO4217_VES: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let bolivar = Discrete.Scale.make_scale symbol "bolivar" (make_q "1/1") in
    let centimo = Discrete.Scale.make_scale symbol "centimo" (make_q "100/1") in
...
module ISO4217_XBD: Custom = struct
  ...
  let description = "Bond Markets Unit European Unit of Account 17 (E.U.A.-17)"
...
module ISO4217_XXX: Custom = struct
  ...
  let description = "The codes assigned for transactions where no currency is involved"
...
module ISO4217_XAU: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let troy_ounce = Discrete.Scale.make_scale symbol "troy-ounce" (make_q "1/1") in
    let grain = Discrete.Scale.make_scale symbol "grain" (make_q "480/1") in
    let milligrain = Discrete.Scale.make_scale symbol "milligrain" (make_q "480000/1") in
    let kilogram = Discrete.Scale.make_scale symbol "kilogram" (make_q "31103477/1000000000") in
    let gram = Discrete.Scale.make_scale symbol "gram" (make_q "31103477/1000000") in
    let milligram = Discrete.Scale.make_scale symbol "milligram" (make_q "31103477/1000") in
    let microgram = Discrete.Scale.make_scale symbol "microgram" (make_q "31103477/1") in
...
module Crypto_BTC: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let bitcoin = Discrete.Scale.make_scale symbol "bitcoin" (make_q "1/1") in
    let millibitcoin = Discrete.Scale.make_scale symbol "millibitcoin" (make_q "1000/1") in
    let satoshi = Discrete.Scale.make_scale symbol "satoshi" (make_q "100000000/1") in
...
module Crypto_ETH: Custom = struct
  ...
  let units =
    ...
    let babbage = Discrete.Scale.make_scale symbol "babbage" (make_q "1000/1") in
    let mwei = Discrete.Scale.make_scale symbol "mwei" (make_q "1000000/1") in
    let lovelace = Discrete.Scale.make_scale symbol "lovelace" (make_q "1000000/1") in
    let gwei = Discrete.Scale.make_scale symbol "gwei" (make_q "1000000000/1") in
    let shannon = Discrete.Scale.make_scale symbol "shannon" (make_q "1000000000/1") in
    let microether = Discrete.Scale.make_scale symbol "microether" (make_q "1000000000000/1") in
    let szabo = Discrete.Scale.make_scale symbol "szabo" (make_q "1000000000000/1") in
    let finney = Discrete.Scale.make_scale symbol "finney" (make_q "1000000000000000/1") in
    let milliether = Discrete.Scale.make_scale symbol "milliether" (make_q "1000000000000000/1") in
    let wei = Discrete.Scale.make_scale symbol "wei" (make_q "1000000000000000000/1") in
...
module Crypto_BNB: Custom = struct
  ...
  let units =
    ...
    let jager = Discrete.Scale.make_scale symbol "jager" (make_q "100000000/1") in
...
module Crypto_DOGE: Custom = struct
  ...
  let units =
    ...
    let koinu = Discrete.Scale.make_scale symbol "koinu" (make_q "100000000/1") in
...
module Crypto_LTC: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let litecoin = Discrete.Scale.make_scale symbol "litecoin" (make_q "1/1") in
    let lite = Discrete.Scale.make_scale symbol "lite" (make_q "1000/1") in
    let photon = Discrete.Scale.make_scale symbol "lite" (make_q "100000000/1") in
...
module Crypto_XRP: Custom = struct
  ...
  let units =
    ...
    let drop = Discrete.Scale.make_scale symbol "drop" (make_q "1000000/1") in
...
module Crypto_XMR: Custom = struct
  ...
  let units =
    ...
    let decinero = Discrete.Scale.make_scale symbol "decinero" (make_q "10/1") in
    let centinero = Discrete.Scale.make_scale symbol "centinero" (make_q "100/1") in
    let millinero = Discrete.Scale.make_scale symbol "millinero" (make_q "1000/1") in
    let micronero = Discrete.Scale.make_scale symbol "micronero" (make_q "1000000/1") in
    let nanonero = Discrete.Scale.make_scale symbol "nanonero" (make_q "1000000000/1") in
    let piconero = Discrete.Scale.make_scale symbol "piconero" (make_q "1000000000000/1") in
...
module Crypto_SOL: Custom = struct
  ...
  let units =
    let table = Hashtbl.create (module String) in
    let sol = Discrete.Scale.make_scale symbol "sol" (make_q "1/1") in
    let lamport = Discrete.Scale.make_scale symbol "lamport" (make_q "100000000/1") in
    Hashtbl.set table ~key: "sol" ~data: sol;
...
module Crypto_DOT: Custom = struct
  ...
  let units =
    ...
    let million = Discrete.Scale.make_scale symbol "million " (make_q "1/1000000") in
    let millidot = Discrete.Scale.make_scale symbol "millidot " (make_q "1000/1") in
    let microdot = Discrete.Scale.make_scale symbol "microdot " (make_q "100000/1") in
    let planck = Discrete.Scale.make_scale symbol "million " (make_q "1000000000/1") in
...
module Crypto_SHIB: Custom = struct
  ...
  let units =
    ...
    let shiboshi = Discrete.Scale.make_scale symbol "shiboshi " (make_q "100000000/1") in
...
module Crypto_XTZ: Custom = struct
  ...
  let units =
    ...
    let mutez = Discrete.Scale.make_scale symbol "mutez " (make_q "1000000/1") in
