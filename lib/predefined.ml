...
module ISO4217_XAU : Custom = struct
  ...
  let units =
    ...
    let kilogram =
      Discrete.Scale.make_scale symbol "kilogram" (make_q "31103477/1000000000")
    in
...
module Crypto_ETH : Custom = struct
  ...
  let units =
    ...
    let microether =
      Discrete.Scale.make_scale symbol "microether" (make_q "1000000000000/1")
    in
    ...
    in
    let milliether =
      Discrete.Scale.make_scale symbol "milliether" (make_q "1000000000000000/1")
    in
